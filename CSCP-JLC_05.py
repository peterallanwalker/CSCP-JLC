...
def wait_for_cscp():
    ...
    # TODO, instead of just waiting, ask mixer for labels
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if jlc_in:
            ...
            # TODO - still blocking / jitter
            # IF I SET THIS TO ALWAYS FALSE,
            # DONT GET CONFLICT BUT STILL LAGGY WHEN MOVING ALL 8 FADERS
            cscp_enabled = True
